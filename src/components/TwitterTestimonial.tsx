...
const TwitterTestimonial: React.FC<TwitterTestimonialProps> = ({
  ...
  return (
    <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 hover:bg-gray-800/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-blue-500/10">
      {/* Header */}
